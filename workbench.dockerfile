...
RUN rm -rf /var/lib/apt/lists/* && \
    ...
    curl -Lo /usr/bin/vcluster https://github.com/loft-sh/vcluster/releases/download/v${VCLUSTER_VERSION}/vcluster-linux-amd64 && \
    chmod 755 /usr/bin/vcluster && \
